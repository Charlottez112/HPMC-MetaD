...
class HPMCMetaD(Action):
    def __init__(
        ...
        Custom HOOMD action for performing Hard Particle Monte Carlo Metadynamics simulations.
        ...
        Args:
            ...
            metad_stride (int): Number of timesteps between successive Gaussian bias depositions.
    ...
    def act(self, timestep):
        ...
        if timestep % self.metad_stride == 1:
